...
var IIgniswapPair = _interopDefault(require('@igniswap/core/build/IIgniswapPair.json'));
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IIgniswapPair.abi, provider).getReserves()).then(function (_ref) {
